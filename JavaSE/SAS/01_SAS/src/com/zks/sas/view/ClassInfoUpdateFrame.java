...
public class ClassInfoUpdateFrame extends JFrame {
    ...
    private int clsId;
    public ClassInfoUpdateFrame(int clsId) {
        this();
        this.clsId = clsId;
        loadData();
    }
    private void loadData() {
        ...
        ClassInfo classInfo = classInfoDAO.findById(clsId);
        txtClsId.setText(clsId + "");
        txtClsName.setText(classInfo.getClsName());
        txtGrade.setText(classInfo.getGrade() + "");
        txtStuCount.setText(classInfo.getStuCount() + "");
        txtTeaNum.setText(classInfo.getTeaNum());
        txtKey1.setText(classInfo.getKey1());
        txtKey2.setText(classInfo.getKey2() + "");

    }
    public ClassInfoUpdateFrame() {
        setTitle("修改班级信息");
        setSize(721, 472);
        ...
        btnOK.addActionListener(e -> {
            ...
            if (classInfoDAO.save(classInfo)) {
                setOkMsg("修改班级信息成功");
                JOptionPane.showMessageDialog(null, "修改班级信息成功", "成功", JOptionPane.INFORMATION_MESSAGE);

            } else {
                setErrorMsg("修改班级信息失败");
                JOptionPane.showMessageDialog(null, "修改班级信息失败", "失败", JOptionPane.ERROR_MESSAGE);
            }
        });
