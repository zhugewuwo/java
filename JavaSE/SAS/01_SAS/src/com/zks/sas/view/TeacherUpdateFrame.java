...
public class TeacherUpdateFrame extends JFrame {
    ...
    private JComboBox cmbTeaTitle;
    private JRadioButton rdBTeaType1;
    private JRadioButton rdBTeaType2;
    private JRadioButton rdbStates1;
    private JRadioButton rdbStates2;
    public TeacherUpdateFrame(String teaNum) {
        this();
        this.teaNum = teaNum;
        loadData();
    }
    private void loadData() {
        ...
        Teacher teacher = teacherDAO.findById(teaNum);
        txtTeaNum.setText(teaNum);
        txtTeaName.setText(teacher.getTeaName());
        txtPwd.setText(teacher.getPwd());
        txtTeaBtd.setText(DateConvert.convertToString(teacher.getTeaBtd()));
        txtTeaEmail.setText(teacher.getKey1());
        txtWorkerAge.setText(teacher.getKey2() + "");
        int selectedIndex = 0;
        switch (teacher.getTeaTitle()) {
            case "副教授":
                selectedIndex = 1;
                break;
            case "讲师":
        ...
        cmbTeaTitle.setSelectedIndex(selectedIndex);
        rdBTeaType1.setSelected(teacher.getTeaType() == 1);
        rdBTeaType2.setSelected(teacher.getTeaType() == 2);
        rdbStates1.setSelected(teacher.getStates() == 1);
        rdbStates2.setSelected(teacher.getStates() == 2);
    ...
    public TeacherUpdateFrame() {
        ...
        JLabel lblNewLabel_1 = new JLabel("修改老师信息");
        ...
        btnOK.addActionListener(e -> {
            ...
            int states = 1;
            if (rdbStates2.isSelected()) states = 2;
            int roleId = 0;
    ...
    public static void main(String[] args) {
        new TeacherUpdateFrame().setVisible(true);
